...
public class MythicalParticles extends TextureSheetParticle {

    private final SpriteSet spriteSet;  // Referência ao SpriteSet

    // Construtor que aceita SpriteSet
    protected MythicalParticles(ClientLevel level, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed, SpriteSet spriteSet) {
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType particleType, ClientLevel level,
            ...
            MythicalParticles particle = new MythicalParticles(level, x, y, z, xSpeed, ySpeed, zSpeed, sprites);
