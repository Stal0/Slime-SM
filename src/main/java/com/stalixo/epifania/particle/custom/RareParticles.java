...
public class RareParticles extends TextureSheetParticle {

    private final SpriteSet spriteSet;  // Referência ao SpriteSet

    // Construtor que aceita SpriteSet
    protected RareParticles(ClientLevel level, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed, SpriteSet spriteSet) {
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType particleType, ClientLevel level,
            ...
            RareParticles particle = new RareParticles(level, x, y, z, xSpeed, ySpeed, zSpeed, sprites);
